...
// User lists to display connected users
var userList = [];
var tempUsers = [];
...
io.on('connection', function (socket) {
	...
	//MODIFY: LKP,BMW,NK 12/6/2017
	socket.on('newChessUpdate', function (data) {
		
		io.emit('updateClientChessInfo', {
